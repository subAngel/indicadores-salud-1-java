 ...
 */
@WebServlet(name = "LeerInformacion", urlPatterns = {"/LeerInformacion"})
public class LeerIndicadores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int tipoActividad = Integer.parseInt(request.getParameter("actividad"));
        
        IndicadoresSalud indicadores;
/*
        basica
        precision
